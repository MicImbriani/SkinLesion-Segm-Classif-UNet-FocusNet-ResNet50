...
def get_focusnetAlpha():
    ...
    up1 = Conv2D(
        396, 2, activation=LeakyReLU(), padding="same", kernel_initializer="he_normal"
    )(UpSampling2D(size=(2, 2))(bottleneck))
    merge1 = Add()([conv4, up1])
    conv5 = focusnetAlphaLayer(396)(merge1)

    up2 = Conv2D(
        255, 2, activation=LeakyReLU(), padding="same", kernel_initializer="he_normal"
    )(UpSampling2D(size=(2, 2))(conv5))
    merge2 = Add()([conv3, up2])
    conv6 = focusnetAlphaLayer(255)(merge2)

    up3 = Conv2D(
        144, 2, activation=LeakyReLU(), padding="same", kernel_initializer="he_normal"
    )(UpSampling2D(size=(2, 2))(conv6))
    merge3 = Add()([conv2, up3])
    conv7 = focusnetAlphaLayer(144)(merge3)

    up4 = Conv2D(
        84, 2, activation=LeakyReLU(), padding="same", kernel_initializer="he_normal"
