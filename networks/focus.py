...
from keras.layers import Conv1D, Conv2D, Activation, Multiply, Add, Concatenate, BatchNormalization
...
def get_focusnetAlpha():
    ...
    # conv1 = focusnetAlphaLayer(48)(conv1)
    # pool1 = basic_2d(48, block=0)(conv1)
