...
import numpy as np
from metrics import dice_coef_loss, auroc, jaccard_coef_loss, true_positive, true_negative, sensitivity, specificity
...
try:
        os.makedirs("/var/tmp/mi714/aug17/models/NEW_mynpy3dimensions/resnet/renets_base(del)", exist_ok=True)
except:
        pass



checkpoint = ModelCheckpoint("resnet_base_weights.h5", 
                             monitor='val_loss',
                             verbose=1,
                             save_best_only=True,
